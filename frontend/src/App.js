    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#18573c" },
                textPrimary: mode === "light" ? "#18573c" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#18573c" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
                options: mode === "light" ? "#fafafa" : "#666",
                fontecor: mode === "light" ? "#18573c" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #18573c, #154b34, #e3651b)" : "#666",
